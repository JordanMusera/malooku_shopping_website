        ...
        <div className='w-full h-full relative p-5 xl:p-0'>
            ...
            <div className='gap-2 flex flex-col'>
                ...
                {orderObj.products.map((item, index) => (
                    <div key={index} className='bg-white rounded-xl h-max p-3 md:p-5 flex flex-col md:flex-row justify-between items-center w-full'>
                    ...
                    <div>
                        <div className='flex gap-3'>
                            <button className='font-bold text-black text-md border border-red-400 bg-red-300 w-full p-1 rounded-md hover:bg-red-400'
                                onClick={() => setRefundCtnVisibility(false)}>Close</button>
                            <button type='submit' className='font-bold text-black text-md border border-pink-300 bg-pink-200 w-full p-1 rounded-md hover:bg-pink-300'
                                onClick={() => cancelPendingOrderFn(clickedProduct.product._id)}>Proceed</button>
                        </div>
                    </div>
