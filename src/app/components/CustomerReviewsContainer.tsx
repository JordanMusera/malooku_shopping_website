      ...
      {reviews.length !== 0 ? (
        <div>
          <div className="flex justify-between">
            <p className="text-md font-semibold text-pink-300">
          ...
          <div className="flex flex-col-reverse gap-2 max-h-screen overflow-auto">
            {reviews.map((item, index) => (
              <div
                key={index}
                className="h-max w-full bg-gray-100 rounded-md p-2 gap-2"
              >
                ...
                <div className="flex gap-3 justify-end">
                  <div
                    ...
                    onClick={() => handleRepliesIconClick(item)}
                  >
                    <img
                ...
                {item._id === clickedItemId && (
                  <div className="flex flex-col gap-2 h-max ps-4">
                    {item.replies.map((item2, index) => (
                      <div
                        className="w-full h-max bg-white mt-2 rounded-bl-xl rounded-r-xl p-2"
                        key={index}
                      >
                        <div className="flex gap-2">
                          <Image
