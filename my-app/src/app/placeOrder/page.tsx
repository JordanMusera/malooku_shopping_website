...
const page = () => {
  return (
    <div className='flex flex-col xl:flex-row relative'>
      ...
      <div className='xl:grid xl:grid-cols-5 xl:h-screen h-max bg-gray-100 xl:w-full w-screen py-5 xl:px-20 px-5 justify-center pt-16'>
      ...
      <div className='xl:fixed xl:top-16 xl:right-4 xl:bottom-4 xl:w-1/5 xl:z-10 items-center justify-center xl:px-0 px-5 bg-gray-100'>
