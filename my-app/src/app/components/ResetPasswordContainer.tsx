...
const ResetPasswordContainer = () => {
  ...
  return (
    <div className='w-full h-full'>
      ...
      <form className='w-1/2 flex flex-col gap-3' onSubmit={requestOtp}>
      ...
      <button className='w-full h-10 rounded-md bg-pink-300' type='submit'>SUBMIT</button>
        ...
        {viewtwo &&(
              <div className='w-full h-full flex flex-col justify-center items-center'>
              <form className='w-1/2 flex flex-col gap-3' onSubmit={changePassword}>
              <p className='w-full h-max text-black font-semibold text-sm'>Enter OTP code sent to this email <span className='text-blue-500'>{email}</span> <span className='text-red-500'><u>change</u></span> <span className='text-orange-500'><u>resend</u></span></p>
